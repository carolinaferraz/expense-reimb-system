...
function getByAmount() {

    let url = 'http://localhost:7777/locked/asc';
    let xhr = new XMLHttpRequest(); 
        ...
        // accessing the data from the req && immediately convert it to a js object (JSON.parse is the opp of JSON.stringify):
            ...
            header.innerText = "By Employee ID > Amount";
        ...
        for(let request of requests) {
            ...
            employee_id.innerText = " - emp_id - 00" + request.employee_id;
    ...
    const filter_link = document.getElementById("amount_asc");
